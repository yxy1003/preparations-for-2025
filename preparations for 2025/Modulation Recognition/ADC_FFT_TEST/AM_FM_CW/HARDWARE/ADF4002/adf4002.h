...
//¹Ü½ÅÉùÃ÷
#define PLL_SCK_0 HAL_GPIO_WritePin(GPIOB,GPIO_PIN_15,GPIO_PIN_RESET)
#define PLL_SCK_1 HAL_GPIO_WritePin(GPIOB,GPIO_PIN_15,GPIO_PIN_SET)
...
#define PLL_SEN_0 HAL_GPIO_WritePin(GPIOB,GPIO_PIN_2,GPIO_PIN_RESET)
#define PLL_SEN_1 HAL_GPIO_WritePin(GPIOB,GPIO_PIN_2,GPIO_PIN_SET)
